 ...
 * @author Tonny Kohar <tonny.kohar@gmail.com>
  */
@ActionID(id = "kiyut.alkitab.modules.downloader.actions.DownloaderAction", category = "Tools")
@ActionRegistration(displayName = "#CTL_DownloaderAction.Text", lazy = false)
@ActionReferences({
